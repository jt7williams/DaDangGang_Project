Shader "NatureManufacture/URP/Road/Transparent Road Cover"
{
    ...
    SubShader
    {
        ...
        half _BaseUsePlanarUV;
        half4 _BaseTilingOffset;
        float4 _BaseNormalMap_TexelSize;
        half _BaseNormalScale;
        float4 _BaseMaskMap_TexelSize;
        half _BaseMetallic;
        half _BaseAORemapMin;
        half _BaseAORemapMax;
        half _BaseSmoothnessRemapMin;
        half _BaseSmoothnessRemapMax;
        float4 _LayerMask_TexelSize;
        half _Invert_Layer_Mask;
        half _Height_Transition;
        half _HeightMin;
        half _HeightMax;
        half _HeightOffset;
        half _HeightMin2;
        half _HeightMax2;
        half _HeightOffset2;
        half IgnoreBase2Alpha;
        half4 _Base2Color;
        float4 _Base2ColorMap_TexelSize;
        half4 _Base2TilingOffset;
        half _Base2UsePlanarUV;
        float4 _Base2NormalMap_TexelSize;
        half _Base2NormalScale;
        float4 _Base2MaskMap_TexelSize;
        half _Base2Metallic;
        half _Base2SmoothnessRemapMin;
        half _Base2SmoothnessRemapMax;
        half _Base2AORemapMin;
        half _Base2AORemapMax;
        float4 _CoverMaskA_TexelSize;
        half _CoverMaskPower;
        half _Cover_Amount;
        half _Cover_Amount_Grow_Speed;
        half _Cover_Max_Angle;
        half _Cover_Min_Height;
        half _Cover_Min_Height_Blending;
        half4 _CoverBaseColor;
        float4 _CoverBaseColorMap_TexelSize;
        half4 _CoverTilingOffset;
        half _CoverUsePlanarUV;
        float4 _CoverNormalMap_TexelSize;
        half _CoverNormalScale;
        half _CoverNormalBlendHardness;
        half _CoverHardness;
        half _CoverHeightMapMin;
        half _CoverHeightMapMax;
        half _CoverHeightMapOffset;
        float4 _CoverMaskMap_TexelSize;
        half _CoverMetallic;
        half _CoverAORemapMin;
        half _CoverAORemapMax;
        half _CoverSmoothnessRemapMin;
        half _CoverSmoothnessRemapMax;
        CBUFFER_END
        ...
        void Unity_Combine_float(half R, half G, half B, half A, out half4 RGBA, out half3 RGB, out half2 RG)
        {
            RGBA = half4(R, G, B, A);
            RGB = half3(R, G, B);
            RG = half2(R, G);
        ...
        void Unity_Divide_float(half A, half B, out half Out)
        {
            Out = A / B;
        }
        ...
        void Unity_Branch_float2(half Predicate, half2 True, half2 False, out half2 Out)
        {
        ...
        void Unity_Maximum_float(half A, half B, out half Out)
        {
            Out = max(A, B);
        }

        void Unity_Subtract_float(half A, half B, out half Out)
        {
            Out = A - B;
        }

        void Unity_Multiply_float(half3 A, half3 B, out half3 Out)
        {
            Out = A * B;
        }

        void Unity_Add_float3(half3 A, half3 B, out half3 Out)
        {
            Out = A + B;
        }
        ...
        void Unity_Divide_float3(half3 A, half3 B, out half3 Out)
        {
            Out = A / B;
        }
        ...
        void Unity_Sign_float3(half3 In, out half3 Out)
        {
            Out = sign(In);
        }

        void Unity_Multiply_float(half2 A, half2 B, out half2 Out)
        {
            Out = A * B;
        }

        void Unity_Add_float2(half2 A, half2 B, out half2 Out)
        {
            Out = A + B;
        }
        ...
        void Unity_Normalize_float3(half3 In, out half3 Out)
        {
            Out = normalize(In);
        }

        void Unity_Branch_float3(half Predicate, half3 True, half3 False, out half3 Out)
        {
            Out = Predicate ? True : False;
        }
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Property_587a28253857318a9b2e59bfc8fb56a4_Out_0 = _BaseTilingOffset;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_7f998178363b4188ba2f07298ef869c1_Out_0 = _BaseUsePlanarUV;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Property_b83097c58639858680bf43881a95b0af_Out_0 = _BaseColor;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Multiply_f572ff0def2d308e87a64e94a46c0d96_Out_2;
            Unity_Multiply_half(_PlanarNM_0b8fbae0d009788d8cd595a3b9bf9f6e_XZ_2, _Property_b83097c58639858680bf43881a95b0af_Out_0, _Multiply_f572ff0def2d308e87a64e94a46c0d96_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_91a015dea8acd38b904ba0935328a5bc_R_1 = _PlanarNM_4245c3b264047180b5c90a697d6cb278_XZ_2[0];
            half _Split_91a015dea8acd38b904ba0935328a5bc_G_2 = _PlanarNM_4245c3b264047180b5c90a697d6cb278_XZ_2[1];
            half _Split_91a015dea8acd38b904ba0935328a5bc_B_3 = _PlanarNM_4245c3b264047180b5c90a697d6cb278_XZ_2[2];
            half _Split_91a015dea8acd38b904ba0935328a5bc_A_4 = _PlanarNM_4245c3b264047180b5c90a697d6cb278_XZ_2[3];
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_fbcff1469ebf488394a8a89ddaf0eb2a_Out_0 = _HeightMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_9df7a44c8225168683743ac60c0c3c34_Out_0 = _HeightMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_9b1e95888c28bc8893f28c02b87fa448_Out_0 = half2(_Property_fbcff1469ebf488394a8a89ddaf0eb2a_Out_0, _Property_9df7a44c8225168683743ac60c0c3c34_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_29ca14fd0b712983a38d63d2dd326e96_Out_0 = _HeightOffset;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Add_cb503f8a09720d84bb03cbd89e37b80c_Out_2;
            Unity_Add_half2(_Vector2_9b1e95888c28bc8893f28c02b87fa448_Out_0, (_Property_29ca14fd0b712983a38d63d2dd326e96_Out_0.xx), _Add_cb503f8a09720d84bb03cbd89e37b80c_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_18f2e96a438d6584ae2fd56f880de9ee_Out_3;
            Unity_Remap_half(_Split_91a015dea8acd38b904ba0935328a5bc_B_3, half2 (0, 1), _Add_cb503f8a09720d84bb03cbd89e37b80c_Out_2, _Remap_18f2e96a438d6584ae2fd56f880de9ee_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            UnityTexture2D _Property_ba3a5f4cba7d0a8fa288ffc8267d6c0e_Out_0 = UnityBuildTexture2DStructNoScale(_Base2ColorMap);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Property_86a4657df480d48e8d3ad3b036731380_Out_0 = _Base2TilingOffset;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_6c5e16c615cab08a97c2a577642b9d83_Out_0 = _Base2UsePlanarUV;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Property_3561b11b899bda8e855826445cf628aa_Out_0 = _Base2Color;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Multiply_d2ec682582195e84acc4a8510f50f4b0_Out_2;
            Unity_Multiply_half(_PlanarNM_5aeab444ca6fd78ea56a01215880a5a4_XZ_2, _Property_3561b11b899bda8e855826445cf628aa_Out_0, _Multiply_d2ec682582195e84acc4a8510f50f4b0_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_c34b73d933404283983f9c8bdb5365d3_R_1 = IN.VertexColor[0];
            half _Split_c34b73d933404283983f9c8bdb5365d3_G_2 = IN.VertexColor[1];
            half _Split_c34b73d933404283983f9c8bdb5365d3_B_3 = IN.VertexColor[2];
            half _Split_c34b73d933404283983f9c8bdb5365d3_A_4 = IN.VertexColor[3];
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_df2df7bb5cfc3381beee7ec454da7542_Out_0 = _Invert_Layer_Mask;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            UnityTexture2D _Property_c7b1e2df9f9b0e8eace9b2274924e69c_Out_0 = UnityBuildTexture2DStructNoScale(_LayerMask);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_RGBA_0 = SAMPLE_TEXTURE2D(_Property_c7b1e2df9f9b0e8eace9b2274924e69c_Out_0.tex, _Property_c7b1e2df9f9b0e8eace9b2274924e69c_Out_0.samplerstate, IN.uv0.xy);
            half _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_R_4 = _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_RGBA_0.r;
            half _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_G_5 = _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_RGBA_0.g;
            half _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_B_6 = _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_RGBA_0.b;
            half _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_A_7 = _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_RGBA_0.a;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _OneMinus_ce5c3c0635d4ac86beb55115d0ebaed7_Out_1;
            Unity_OneMinus_half(_SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_R_4, _OneMinus_ce5c3c0635d4ac86beb55115d0ebaed7_Out_1);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Branch_af0c5e511241ce8eae748ae487df50fa_Out_3;
            Unity_Branch_half(_Property_df2df7bb5cfc3381beee7ec454da7542_Out_0, _OneMinus_ce5c3c0635d4ac86beb55115d0ebaed7_Out_1, _SampleTexture2D_175fb18fafc9598382f1f5f7e97bf30a_R_4, _Branch_af0c5e511241ce8eae748ae487df50fa_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_83ec66b648ab6c84848b42686c256cd7_R_1 = _PlanarNM_d5657f470f05ef839e4c257a20ace8cb_XZ_2[0];
            half _Split_83ec66b648ab6c84848b42686c256cd7_G_2 = _PlanarNM_d5657f470f05ef839e4c257a20ace8cb_XZ_2[1];
            half _Split_83ec66b648ab6c84848b42686c256cd7_B_3 = _PlanarNM_d5657f470f05ef839e4c257a20ace8cb_XZ_2[2];
            half _Split_83ec66b648ab6c84848b42686c256cd7_A_4 = _PlanarNM_d5657f470f05ef839e4c257a20ace8cb_XZ_2[3];
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_ce1750e5c69e97818667b412fc3f9f2c_Out_0 = _HeightMin2;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_8e0f2ea54d8ede89bbabdf31a9bafd57_Out_0 = _HeightMax2;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_fb6c6dd7e70e768ba686e8e94153bb96_Out_0 = half2(_Property_ce1750e5c69e97818667b412fc3f9f2c_Out_0, _Property_8e0f2ea54d8ede89bbabdf31a9bafd57_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_151ae2702b614585af2000f0a812960f_Out_0 = _HeightOffset2;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Add_fd1b3d8e24e77087a55888eeb238f1a6_Out_2;
            Unity_Add_half2(_Vector2_fb6c6dd7e70e768ba686e8e94153bb96_Out_0, (_Property_151ae2702b614585af2000f0a812960f_Out_0.xx), _Add_fd1b3d8e24e77087a55888eeb238f1a6_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_3d4180c0ab36ba86a5517b2645f0bfa7_Out_3;
            Unity_Remap_half(_Split_83ec66b648ab6c84848b42686c256cd7_B_3, half2 (0, 1), _Add_fd1b3d8e24e77087a55888eeb238f1a6_Out_2, _Remap_3d4180c0ab36ba86a5517b2645f0bfa7_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_2cb0e5aa384654828f0453a44884573c_Out_2;
            Unity_Multiply_half(_Branch_af0c5e511241ce8eae748ae487df50fa_Out_3, _Remap_3d4180c0ab36ba86a5517b2645f0bfa7_Out_3, _Multiply_2cb0e5aa384654828f0453a44884573c_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_74def30593cbbb8bbed03613a31cb89a_Out_2;
            Unity_Multiply_half(_Split_c34b73d933404283983f9c8bdb5365d3_R_1, _Multiply_2cb0e5aa384654828f0453a44884573c_Out_2, _Multiply_74def30593cbbb8bbed03613a31cb89a_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_818c8af4b930138e81034c886614171d_Out_0 = _Height_Transition;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Property_822489d2e6d3e08590c64f085ffd9b2e_Out_0 = _CoverTilingOffset;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_2ae4a163bd21d98789af282d6e469175_Out_0 = _CoverUsePlanarUV;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Property_55e7941fa7ac5f8387aa9bb633b08883_Out_0 = _CoverBaseColor;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _Multiply_a38ba695a2660c8691763f0bd7fe159c_Out_2;
            Unity_Multiply_half(_PlanarNM_8bb420494d19b28e9ccdff489802dc81_XZ_2, _Property_55e7941fa7ac5f8387aa9bb633b08883_Out_0, _Multiply_a38ba695a2660c8691763f0bd7fe159c_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            UnityTexture2D _Property_c0d223db25424a8ab0cee2de2bbf58ce_Out_0 = UnityBuildTexture2DStructNoScale(_CoverMaskA);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _UV_5352c8dd0add178ba83a5421c2c0b3f0_Out_0 = IN.uv0;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half4 _SampleTexture2D_024ba490c015248988a12a9d670014ea_RGBA_0 = SAMPLE_TEXTURE2D(_Property_c0d223db25424a8ab0cee2de2bbf58ce_Out_0.tex, _Property_c0d223db25424a8ab0cee2de2bbf58ce_Out_0.samplerstate, (_UV_5352c8dd0add178ba83a5421c2c0b3f0_Out_0.xy));
            half _SampleTexture2D_024ba490c015248988a12a9d670014ea_R_4 = _SampleTexture2D_024ba490c015248988a12a9d670014ea_RGBA_0.r;
            half _SampleTexture2D_024ba490c015248988a12a9d670014ea_G_5 = _SampleTexture2D_024ba490c015248988a12a9d670014ea_RGBA_0.g;
            half _SampleTexture2D_024ba490c015248988a12a9d670014ea_B_6 = _SampleTexture2D_024ba490c015248988a12a9d670014ea_RGBA_0.b;
            half _SampleTexture2D_024ba490c015248988a12a9d670014ea_A_7 = _SampleTexture2D_024ba490c015248988a12a9d670014ea_RGBA_0.a;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_b80e7b96604b7c82bbf9bff4981fad76_Out_0 = _CoverMaskPower;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_abe410d256783480b1b58468bf78a882_Out_2;
            Unity_Multiply_half(_SampleTexture2D_024ba490c015248988a12a9d670014ea_A_7, _Property_b80e7b96604b7c82bbf9bff4981fad76_Out_0, _Multiply_abe410d256783480b1b58468bf78a882_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Clamp_a78f6f28770afd869adb9d12cd47370b_Out_3;
            Unity_Clamp_half(_Multiply_abe410d256783480b1b58468bf78a882_Out_2, 0, 1, _Clamp_a78f6f28770afd869adb9d12cd47370b_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_d4b0759cf4647e81be065ec1465ce2b4_Out_0 = _BaseNormalScale;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _NormalStrength_f66a9108ea294886acc61513b41cc5e4_Out_2;
            Unity_NormalStrength_half((_PlanarNMn_a3713a9c3874b6838d0eda971b9c62d8_XZ_2.xyz), _Property_d4b0759cf4647e81be065ec1465ce2b4_Out_0, _NormalStrength_f66a9108ea294886acc61513b41cc5e4_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_8c31443b776727819a663c7ddce79064_Out_0 = _Base2NormalScale;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _NormalStrength_0fb86880ab8e368dac6d01b830e20ed8_Out_2;
            Unity_NormalStrength_half((_PlanarNMn_d7b3ec528088a085a5102e025a1b45cf_XZ_2.xyz), _Property_8c31443b776727819a663c7ddce79064_Out_0, _NormalStrength_0fb86880ab8e368dac6d01b830e20ed8_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_19f92cae42737480a95820c51d4ba124_Out_0 = _CoverNormalBlendHardness;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _NormalStrength_2c3488591b8345869feb25a3dee06c3f_Out_2;
            Unity_NormalStrength_half((_PlanarNMn_248bc5b7421d3f828d166902c73ca6c3_XZ_2.xyz), _Property_19f92cae42737480a95820c51d4ba124_Out_0, _NormalStrength_2c3488591b8345869feb25a3dee06c3f_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_96bfe9cb80ad308385c191d094b3d071_R_1 = IN.WorldSpaceNormal[0];
            half _Split_96bfe9cb80ad308385c191d094b3d071_G_2 = IN.WorldSpaceNormal[1];
            half _Split_96bfe9cb80ad308385c191d094b3d071_B_3 = IN.WorldSpaceNormal[2];
            half _Split_96bfe9cb80ad308385c191d094b3d071_A_4 = 0;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_0dd796aae8cd9f878bef13ceac4fe3ec_Out_0 = _Cover_Amount;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_67285cdc688aa38d83f62d5bb095d597_Out_0 = _Cover_Amount_Grow_Speed;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Subtract_fcefec675e7536888eccf5574d921972_Out_2;
            Unity_Subtract_half(4, _Property_67285cdc688aa38d83f62d5bb095d597_Out_0, _Subtract_fcefec675e7536888eccf5574d921972_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Divide_1e25465528e612839a4ce1faedd89e7d_Out_2;
            Unity_Divide_half(_Property_0dd796aae8cd9f878bef13ceac4fe3ec_Out_0, _Subtract_fcefec675e7536888eccf5574d921972_Out_2, _Divide_1e25465528e612839a4ce1faedd89e7d_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Absolute_d20b810ffdec828ab74dd6692d82f01b_Out_1;
            Unity_Absolute_half(_Divide_1e25465528e612839a4ce1faedd89e7d_Out_2, _Absolute_d20b810ffdec828ab74dd6692d82f01b_Out_1);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Power_181fbf47cfdb258da1fe0b72a450986f_Out_2;
            Unity_Power_half(_Absolute_d20b810ffdec828ab74dd6692d82f01b_Out_1, _Subtract_fcefec675e7536888eccf5574d921972_Out_2, _Power_181fbf47cfdb258da1fe0b72a450986f_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Clamp_11f62dba01f1a38c9e0a9972ccd19246_Out_3;
            Unity_Clamp_half(_Power_181fbf47cfdb258da1fe0b72a450986f_Out_2, 0, 2, _Clamp_11f62dba01f1a38c9e0a9972ccd19246_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_9810f6d76275cd8fbe5e3a02360b98a7_Out_2;
            Unity_Multiply_half(_Split_96bfe9cb80ad308385c191d094b3d071_G_2, _Clamp_11f62dba01f1a38c9e0a9972ccd19246_Out_3, _Multiply_9810f6d76275cd8fbe5e3a02360b98a7_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Saturate_a007c5f214685c87bf6ca3e64c06b488_Out_1;
            Unity_Saturate_half(_Multiply_9810f6d76275cd8fbe5e3a02360b98a7_Out_2, _Saturate_a007c5f214685c87bf6ca3e64c06b488_Out_1);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Clamp_1b2b25b617fc508b9835f0309136fd00_Out_3;
            Unity_Clamp_half(_Split_96bfe9cb80ad308385c191d094b3d071_G_2, 0, 0.9999, _Clamp_1b2b25b617fc508b9835f0309136fd00_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_7b12276ea7a4538db6804507b30a830c_Out_0 = _Cover_Max_Angle;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Divide_54c523ff4b7acb858e9e368fd1e4d34a_Out_2;
            Unity_Divide_half(_Property_7b12276ea7a4538db6804507b30a830c_Out_0, 45, _Divide_54c523ff4b7acb858e9e368fd1e4d34a_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _OneMinus_6cf431985b651e8e9546ae6cb2d4d668_Out_1;
            Unity_OneMinus_half(_Divide_54c523ff4b7acb858e9e368fd1e4d34a_Out_2, _OneMinus_6cf431985b651e8e9546ae6cb2d4d668_Out_1);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Subtract_4ef7b60aeab8d589bf2d2423737642bc_Out_2;
            Unity_Subtract_half(_Clamp_1b2b25b617fc508b9835f0309136fd00_Out_3, _OneMinus_6cf431985b651e8e9546ae6cb2d4d668_Out_1, _Subtract_4ef7b60aeab8d589bf2d2423737642bc_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Clamp_a4b51894ea17818c9a27bb533a2ebe74_Out_3;
            Unity_Clamp_half(_Subtract_4ef7b60aeab8d589bf2d2423737642bc_Out_2, 0, 2, _Clamp_a4b51894ea17818c9a27bb533a2ebe74_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Divide_c4196d4f02190b89ba827ccd4ae8a74d_Out_2;
            Unity_Divide_half(1, _Divide_54c523ff4b7acb858e9e368fd1e4d34a_Out_2, _Divide_c4196d4f02190b89ba827ccd4ae8a74d_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_ffc22433163d1184846ede424b44bcb2_Out_2;
            Unity_Multiply_half(_Clamp_a4b51894ea17818c9a27bb533a2ebe74_Out_3, _Divide_c4196d4f02190b89ba827ccd4ae8a74d_Out_2, _Multiply_ffc22433163d1184846ede424b44bcb2_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Absolute_c2e5757082de5d878d4c023806fb2108_Out_1;
            Unity_Absolute_half(_Multiply_ffc22433163d1184846ede424b44bcb2_Out_2, _Absolute_c2e5757082de5d878d4c023806fb2108_Out_1);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_849d9f217c95f38c9d49ab251578d8d5_Out_0 = _CoverHardness;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Power_578546d66d69a5829b745ebba1279adf_Out_2;
            Unity_Power_half(_Absolute_c2e5757082de5d878d4c023806fb2108_Out_1, _Property_849d9f217c95f38c9d49ab251578d8d5_Out_0, _Power_578546d66d69a5829b745ebba1279adf_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_34d2d3aff4814e8e83d2894b3512c6c8_Out_0 = _Cover_Min_Height;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _OneMinus_474df64227f004849b34c68fe8df93f2_Out_1;
            Unity_OneMinus_half(_Property_34d2d3aff4814e8e83d2894b3512c6c8_Out_0, _OneMinus_474df64227f004849b34c68fe8df93f2_Out_1);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_7b91fd6e21b46c85816c7b681307cbe4_Out_0 = _Cover_Min_Height_Blending;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_f2887eb409f6bb81ae4caad2b01b17f1_Out_2;
            Unity_Multiply_half(_Clamp_11f62dba01f1a38c9e0a9972ccd19246_Out_3, _Property_849d9f217c95f38c9d49ab251578d8d5_Out_0, _Multiply_f2887eb409f6bb81ae4caad2b01b17f1_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_86ec1aefda4f9e8e82b79c6195b397b0_R_1 = _PlanarNM_819c993d9b62a28ea640d2bacdc62c6e_XZ_2[0];
            half _Split_86ec1aefda4f9e8e82b79c6195b397b0_G_2 = _PlanarNM_819c993d9b62a28ea640d2bacdc62c6e_XZ_2[1];
            half _Split_86ec1aefda4f9e8e82b79c6195b397b0_B_3 = _PlanarNM_819c993d9b62a28ea640d2bacdc62c6e_XZ_2[2];
            half _Split_86ec1aefda4f9e8e82b79c6195b397b0_A_4 = _PlanarNM_819c993d9b62a28ea640d2bacdc62c6e_XZ_2[3];
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_c9c6897e00458b8f8aa07df49fa519bc_Out_0 = _CoverHeightMapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_ab94650b8edd82828661fe99e3c0e849_Out_0 = _CoverHeightMapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_fe489f7321f6568686816b9eecbc16d1_Out_0 = half2(_Property_c9c6897e00458b8f8aa07df49fa519bc_Out_0, _Property_ab94650b8edd82828661fe99e3c0e849_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_c1ab40024cb83b87960e4327efbd997f_Out_0 = _CoverHeightMapOffset;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Add_4a359522fc231c83b55ef23f341b6fb3_Out_2;
            Unity_Add_half2(_Vector2_fe489f7321f6568686816b9eecbc16d1_Out_0, (_Property_c1ab40024cb83b87960e4327efbd997f_Out_0.xx), _Add_4a359522fc231c83b55ef23f341b6fb3_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_5aee5b64d41562858dc7c42d8b748894_Out_3;
            Unity_Remap_half(_Split_86ec1aefda4f9e8e82b79c6195b397b0_B_3, half2 (0, 1), _Add_4a359522fc231c83b55ef23f341b6fb3_Out_2, _Remap_5aee5b64d41562858dc7c42d8b748894_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_7b9efcab84158389b4a4ea1e24b5601a_Out_0 = _CoverNormalScale;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _NormalStrength_8f42544d1b3ae08092fb1812b8119cfa_Out_2;
            Unity_NormalStrength_half((_PlanarNMn_248bc5b7421d3f828d166902c73ca6c3_XZ_2.xyz), _Property_7b9efcab84158389b4a4ea1e24b5601a_Out_0, _NormalStrength_8f42544d1b3ae08092fb1812b8119cfa_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_afd0f3561038ef8487e614f350d364dd_Out_0 = _BaseMetallic;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_154e0f89b19c8e86926222afb13691e3_Out_2;
            Unity_Multiply_half(_Split_91a015dea8acd38b904ba0935328a5bc_R_1, _Property_afd0f3561038ef8487e614f350d364dd_Out_0, _Multiply_154e0f89b19c8e86926222afb13691e3_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_b82ce26778f44c8fa3510d1a8ed92d0d_Out_0 = _BaseAORemapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_9d07c7a09a85da809f1d4661406e0888_Out_0 = _BaseAORemapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_10162c774de2a7838426399cfe98be82_Out_0 = half2(_Property_b82ce26778f44c8fa3510d1a8ed92d0d_Out_0, _Property_9d07c7a09a85da809f1d4661406e0888_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_c45fda31db668c81a9e89e11297ec993_Out_3;
            Unity_Remap_half(_Split_91a015dea8acd38b904ba0935328a5bc_G_2, half2 (0, 1), _Vector2_10162c774de2a7838426399cfe98be82_Out_0, _Remap_c45fda31db668c81a9e89e11297ec993_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_04a7bb2753456b8293b3e46e346b646e_Out_0 = _BaseSmoothnessRemapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_75c8631fc908bb8ba8542d2e70d18cbf_Out_0 = _BaseSmoothnessRemapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_b2e1a3c487cdf88f9b5992b831ba24d6_Out_0 = half2(_Property_04a7bb2753456b8293b3e46e346b646e_Out_0, _Property_75c8631fc908bb8ba8542d2e70d18cbf_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_65ca5af95590f88da70777476b6efd40_Out_3;
            Unity_Remap_half(_Split_91a015dea8acd38b904ba0935328a5bc_A_4, half2 (0, 1), _Vector2_b2e1a3c487cdf88f9b5992b831ba24d6_Out_0, _Remap_65ca5af95590f88da70777476b6efd40_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _Vector3_28c1e2dadb10138a9799d970043db9b0_Out_0 = half3(_Multiply_154e0f89b19c8e86926222afb13691e3_Out_2, _Remap_c45fda31db668c81a9e89e11297ec993_Out_3, _Remap_65ca5af95590f88da70777476b6efd40_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_4ead43cc6d37b68eb268dd80c3a561e9_Out_0 = _Base2Metallic;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_eef7838a4634498b9cf12d1bee89d853_Out_2;
            Unity_Multiply_half(_Split_83ec66b648ab6c84848b42686c256cd7_R_1, _Property_4ead43cc6d37b68eb268dd80c3a561e9_Out_0, _Multiply_eef7838a4634498b9cf12d1bee89d853_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_e1ed9fe432388887abb17b07dcc5ca6b_Out_0 = _Base2AORemapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_cb0cf7882dcbcf88989a12f73fb7c917_Out_0 = _Base2AORemapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_2d74d82ae79d5681a097c2e3ce20c913_Out_0 = half2(_Property_e1ed9fe432388887abb17b07dcc5ca6b_Out_0, _Property_cb0cf7882dcbcf88989a12f73fb7c917_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_dcd2e2871e334281a15cdd1da6103c7f_Out_3;
            Unity_Remap_half(_Split_83ec66b648ab6c84848b42686c256cd7_G_2, half2 (0, 1), _Vector2_2d74d82ae79d5681a097c2e3ce20c913_Out_0, _Remap_dcd2e2871e334281a15cdd1da6103c7f_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_159cd47513de4f85a992da1f43f77c51_Out_0 = _Base2SmoothnessRemapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_b1f3c7061cf84380b1a0ffc2c5f770db_Out_0 = _Base2SmoothnessRemapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_eb0fcc98def54d83abe1cfec60457b78_Out_0 = half2(_Property_159cd47513de4f85a992da1f43f77c51_Out_0, _Property_b1f3c7061cf84380b1a0ffc2c5f770db_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_1214803bb0f7c387adc088fb938f7971_Out_3;
            Unity_Remap_half(_Split_83ec66b648ab6c84848b42686c256cd7_A_4, half2 (0, 1), _Vector2_eb0fcc98def54d83abe1cfec60457b78_Out_0, _Remap_1214803bb0f7c387adc088fb938f7971_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _Vector3_ddb5452f73a0dc819b57dbe981a5f4e7_Out_0 = half3(_Multiply_eef7838a4634498b9cf12d1bee89d853_Out_2, _Remap_dcd2e2871e334281a15cdd1da6103c7f_Out_3, _Remap_1214803bb0f7c387adc088fb938f7971_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_6dbb3498614f2088a1315529ed864ea3_Out_0 = _CoverMetallic;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_7a0f3f362f18fd86b9191e28255508f8_Out_2;
            Unity_Multiply_half(_Split_86ec1aefda4f9e8e82b79c6195b397b0_R_1, _Property_6dbb3498614f2088a1315529ed864ea3_Out_0, _Multiply_7a0f3f362f18fd86b9191e28255508f8_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_840e5ecb6a2ddb83abffd7be403ecd68_Out_0 = _CoverAORemapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_92176ee70059d28abbfcad689b580f1a_Out_0 = _CoverAORemapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_2b0ddb771cc86988a6f70ca3c4d0145b_Out_0 = half2(_Property_840e5ecb6a2ddb83abffd7be403ecd68_Out_0, _Property_92176ee70059d28abbfcad689b580f1a_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_1091f204ac00858d804a3785be14a17e_Out_3;
            Unity_Remap_half(_Split_86ec1aefda4f9e8e82b79c6195b397b0_G_2, half2 (0, 1), _Vector2_2b0ddb771cc86988a6f70ca3c4d0145b_Out_0, _Remap_1091f204ac00858d804a3785be14a17e_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_4cd4964a0372a3858a89e499b8d810a1_Out_0 = _CoverSmoothnessRemapMin;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_f7e67cf191e5c38388370531311427cf_Out_0 = _CoverSmoothnessRemapMax;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half2 _Vector2_60ae45a9f680358085440c61ca0118da_Out_0 = half2(_Property_4cd4964a0372a3858a89e499b8d810a1_Out_0, _Property_f7e67cf191e5c38388370531311427cf_Out_0);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Remap_e88a1283399b2187be29c818a3fc3543_Out_3;
            Unity_Remap_half(_Split_86ec1aefda4f9e8e82b79c6195b397b0_A_4, half2 (0, 1), _Vector2_60ae45a9f680358085440c61ca0118da_Out_0, _Remap_e88a1283399b2187be29c818a3fc3543_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half3 _Vector3_83d0f92fd33a1d8799fdafb5ae407cb7_Out_0 = half3(_Multiply_7a0f3f362f18fd86b9191e28255508f8_Out_2, _Remap_1091f204ac00858d804a3785be14a17e_Out_3, _Remap_e88a1283399b2187be29c818a3fc3543_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            ...
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_c7a719bf7da79a8ea38d7311fd844f92_R_1 = _Multiply_f572ff0def2d308e87a64e94a46c0d96_Out_2[0];
            half _Split_c7a719bf7da79a8ea38d7311fd844f92_G_2 = _Multiply_f572ff0def2d308e87a64e94a46c0d96_Out_2[1];
            half _Split_c7a719bf7da79a8ea38d7311fd844f92_B_3 = _Multiply_f572ff0def2d308e87a64e94a46c0d96_Out_2[2];
            half _Split_c7a719bf7da79a8ea38d7311fd844f92_A_4 = _Multiply_f572ff0def2d308e87a64e94a46c0d96_Out_2[3];
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_7c5dae9b46c9e686b49e58fa996a104a_Out_0 = IgnoreBase2Alpha;
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Split_e9060f5c0433ec889696d3e462f3229b_R_1 = _Multiply_d2ec682582195e84acc4a8510f50f4b0_Out_2[0];
            half _Split_e9060f5c0433ec889696d3e462f3229b_G_2 = _Multiply_d2ec682582195e84acc4a8510f50f4b0_Out_2[1];
            half _Split_e9060f5c0433ec889696d3e462f3229b_B_3 = _Multiply_d2ec682582195e84acc4a8510f50f4b0_Out_2[2];
            half _Split_e9060f5c0433ec889696d3e462f3229b_A_4 = _Multiply_d2ec682582195e84acc4a8510f50f4b0_Out_2[3];
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Branch_a7d7aece30fd9b8eb456d191fdd37a06_Out_3;
            Unity_Branch_half(_Property_7c5dae9b46c9e686b49e58fa996a104a_Out_0, _Split_c7a719bf7da79a8ea38d7311fd844f92_A_4, _Split_e9060f5c0433ec889696d3e462f3229b_A_4, _Branch_a7d7aece30fd9b8eb456d191fdd37a06_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Lerp_8692ca93f568998fbc97130b6dbc4556_Out_3;
            Unity_Lerp_half(_Split_c7a719bf7da79a8ea38d7311fd844f92_A_4, _Branch_a7d7aece30fd9b8eb456d191fdd37a06_Out_3, _Multiply_74def30593cbbb8bbed03613a31cb89a_Out_2, _Lerp_8692ca93f568998fbc97130b6dbc4556_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Clamp_0c8b7b55b9f82588ab2dcff09ee7a16d_Out_3;
            Unity_Clamp_half(_Lerp_8692ca93f568998fbc97130b6dbc4556_Out_3, 0, 1, _Clamp_0c8b7b55b9f82588ab2dcff09ee7a16d_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Multiply_6333dc4a6348088bb7281602ce6bff5f_Out_2;
            Unity_Multiply_half(_Clamp_0c8b7b55b9f82588ab2dcff09ee7a16d_Out_3, _Split_c34b73d933404283983f9c8bdb5365d3_A_4, _Multiply_6333dc4a6348088bb7281602ce6bff5f_Out_2);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Clamp_9642b8fb7e32b18a91da1888c9bc375b_Out_3;
            Unity_Clamp_half(_Multiply_6333dc4a6348088bb7281602ce6bff5f_Out_2, 0, 1, _Clamp_9642b8fb7e32b18a91da1888c9bc375b_Out_3);
            #endif
            #if defined(KEYWORD_PERMUTATION_0) || defined(KEYWORD_PERMUTATION_1)
            half _Property_8bc98dd454a5508b9864a6ba09772356_Out_0 = _AlphaCutoff;
            #endif
